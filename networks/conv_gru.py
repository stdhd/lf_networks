...
class ConvGRUCell(nn.Module):
    ...
    def forward(self, input_, prev_state):
        ...
        #print(input_.size(), prev_state.size(), reset.size(), stacked_inputs.size(), self.reset_gate(stacked_inputs).size())
...
class ConvGRU(nn.Module):
    ...
    def __init__(self, input_size, hidden_sizes, kernel_sizes, n_layers, upsampling:list=None, **params):
        '''
