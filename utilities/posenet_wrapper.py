...
class PoseNetWrapper(nn.Module):
    def __init__(self,config):
        super().__init__()
        self.model_path = '/export/scratch/ablattma/pose_estimator/deep-high-resolution-net.pytorch/models/pytorch/pose_mpii/pose_resnet_152_256x256.pth'
...
if __name__ == '__main__':
    ...
    from utilities.metrics import KPSMetric
