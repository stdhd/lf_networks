...
if __name__ == '__main__':
    ...
    if args.mode =='variance_reduction':
        ...
        # csv_path = '/export/scratch/ablattma/poking_inn/second_stage_video/generated/plants-16_10d1-bs20-lr1e-3-bn64-fullseq-mfc32-ss128-mf10-endpoint-np5/metrics/plot_data_50pokes_lpips.csv'
        csv_path ='/export/scratch/ablattma/poking_inn/second_stage_video/generated/iper-16_10d1-bs96-lr1e-3-bn128-fullseq-ss128-mf10-endpoint-np5-mweight/metrics/plot_data_50pokes_kps.csv'
        key = 'MSE'

        df = pd.read_csv(csv_path,sep=',')

        os.makedirs('/export/scratch/ablattma/poking_inn/plots_results',exist_ok=True)
        save_path = '/export/scratch/ablattma/poking_inn/plots_results/time_plot_iper.pdf'
        ...
        savepath = '/export/scratch/ablattma/poking_inn/plots_results/uncertainty_reduction_iper.pdf'
        make_two_axes_plot(df,savepath,key_y1=f'Mean {key}',title='iPER Dataset')

    else:

        in_path = '/export/scratch/ablattma/poking_inn/plots_results/kps_acc_targeted_ipoke.csv'
        ...
        plt.tight_layout()
        fig.savefig('/export/scratch/ablattma/poking_inn/plots_results/kps_acc_violin_squeeze_ipoke.pdf')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig('/export/scratch/ablattma/poking_inn/plots_results/kps_acc_box.pdf')
        plt.close()